...
dia_1_x, dia_1_y = ImportTrafficData.in_classification_model_format('../../data/051218_60h6sw_c1_ht5_it0_V2_csv_ddos_portscan',
                                                                   # Os ataques acontecem nesses horários:
                                                                   [('10:15:00', '11:30:00'),
                                                                    ('13:25:00', '14:35:00')])


dia_2_x, dia_2_y = ImportTrafficData.in_classification_model_format('../../data/171218_60h6sw_c1_ht5_it0_V2_csv_portscan_ddos',
                                                                   [('09:45:00', '11:10:00'),
                                                                    ('17:37:00', '18:55:00')])

dia_3_x, dia_3_y = ImportTrafficData.in_classification_model_format('../../data/120319_60h6sw_c1_ht5_it0_V2_csv_portscan_ddos',
                                                                   [('09:29:00', '10:44:00'),
                                                                    ('16:16:00', '17:50:00')])
...
if sys.argv.count("-t"):
    ...
    model.fit(dia_1_x, dia_1_y,
              validation_data=(dia_2_x, dia_2_y),
              batch_size=60,
              epochs=20)
...
model.evaluate(dia_3_x, dia_3_y, verbose=2)
...
#
print("\nPrevendo anomalias no dataset de teste...")
predictions = model.predict(dia_3_x)
