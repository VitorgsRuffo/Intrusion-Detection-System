...
normal_day_labels = ImportTrafficData.in_gru_regression_model_20_sec_format('../../../../../Data/orion/051218_60h6sw_c1_ht5_it0_V2_csv', [])


day_1_x, day_1_y,\
day_1_labels = ImportTrafficData.in_gru_regression_model_20_sec_format('../../../../../Data/orion/051218_60h6sw_c1_ht5_it0_V2_csv_ddos_portscan',
...
day_2_x, day_2_y,\
day_2_labels = ImportTrafficData.in_gru_regression_model_20_sec_format('../../../../../Data/orion/120319_60h6sw_c1_ht5_it0_V2_csv_portscan_ddos',
                                                            [('09:29:00', '10:44:00'),
                                                            ('16:16:00', '17:50:00')])


day_3_x, day_3_y,\
day_3_labels = ImportTrafficData.in_gru_regression_model_20_sec_format('../../../../../Data/orion/171218_60h6sw_c1_ht5_it0_V2_csv_portscan_ddos',
                                                            [('09:45:00', '11:10:00'),
                                                            ('17:37:00', '18:55:00')])
...
if sys.argv.count("-t"):
    model = LaymanAnomalyDetector((normal_day_x.shape[1], normal_day_x.shape[2]), (64, 1), "mse", "adam", ["accuracy"], 0.2)
