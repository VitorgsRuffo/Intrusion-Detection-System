...
# training_x, training_y = ImportTrafficData.in_classification_model_format2('../training_day_1.csv')
# testing_x, testing_y = ImportTrafficData.in_classification_model_format2('../testing_day_1.csv')

# training_x, validating_x, training_y, validating_y = train_test_split(training_x, training_y, test_size=0.33)
# 
# training_x = np.array(training_x)
# training_y = np.array(training_y)
# validating_x = np.array(validating_x)
# validating_y = np.array(validating_y)

training_x, training_y = ImportTrafficData.in_classification_model_ugr16_format('../../../Data/ugr16/testing/testing_day_1.csv')

testing_x, testing_y = training_x[43200:], training_y[43200:]
training_x, training_y = training_x[:43200], training_y[:43200]
...
if sys.argv.count("-t"):
    ...
    #    Para cada batch:
    #       O otimizador configurará a funcao de perda considerando os dados do batch atual.
